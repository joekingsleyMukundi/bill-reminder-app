...
import com.qrolic.reminderapp.databinding.ActivityCalendarDayBinding
            ...
            this.coroutineContext.let {
                ...
                if (long > 0) {
                    if (System.currentTimeMillis()< postponeMillies){
                        onSchedulAlarm(postponeMillies.toLong(),reminderTitle!!,addNewReminderTable.repeat!!,reminderAlarmId.toInt(),reminderReportAs!!)
