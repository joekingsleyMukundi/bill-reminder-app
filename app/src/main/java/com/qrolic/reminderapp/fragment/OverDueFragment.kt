...
import com.qrolic.reminderapp.databinding.FragmentOverDueBinding
...
class OverDueFragment : Fragment() {
    ...
    lateinit var fragmentOverDueBinding: FragmentOverDueBinding
    ...
    override fun onCreateView(
        ...
        fragmentOverDueBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_over_due,
            container,
            false
        )
        initAll()
        return fragmentOverDueBinding.root
    }
    ...
    private fun initAll() {
        ...
        fragmentOverDueBinding.rvOverDueReminderList.layoutManager = layoutManager
        fragmentOverDueBinding.rvOverDueReminderList.itemAnimator = DefaultItemAnimator()
        fragmentOverDueBinding.rvOverDueReminderList.adapter = remindeLisAdapter
        ...
        lifecycleScope.launch {
            this.coroutineContext.let {
                ...
                if(reminderTableList.isEmpty()){
                    fragmentOverDueBinding.rvOverDueReminderList.visibility = View.GONE
                    fragmentOverDueBinding.llEmptyLayout.visibility = View.VISIBLE
                }else{
                    fragmentOverDueBinding.rvOverDueReminderList.visibility = View.VISIBLE
                    fragmentOverDueBinding.llEmptyLayout.visibility = View.GONE
                }
