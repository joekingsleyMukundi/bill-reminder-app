...
import com.qrolic.reminderapp.databinding.FragmentTodayBinding
...
class TodayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentTodayBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_today, container, false)
        initAll()
    ...
    private fun initAll() {
        ...
        fragmentTodayBinding.rvTodayReminderList.layoutManager = layoutManager
        fragmentTodayBinding.rvTodayReminderList.itemAnimator = DefaultItemAnimator()
        fragmentTodayBinding.rvTodayReminderList.adapter = remindeLisAdapter
        ...
        lifecycleScope.launch {
            this.coroutineContext.let {
                ...
                if(reminderTableList.isEmpty()){
                    fragmentTodayBinding.rvTodayReminderList.visibility = View.GONE
                    fragmentTodayBinding.llEmptyLayout.visibility = View.VISIBLE
                }else{
                    fragmentTodayBinding.rvTodayReminderList.visibility = View.VISIBLE
                    fragmentTodayBinding.llEmptyLayout.visibility = View.GONE
                }
